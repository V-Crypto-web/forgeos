...
class ProviderRouter:
    ...
    def __init__(self):
        ...
        self.routing_policy = {
            ModelRole.PLANNER:  ["gpt-4o", "claude-3-5-sonnet-20240620", "gemini/gemini-1.5-pro"],
            ModelRole.CODER:    ["gpt-4o", "claude-3-5-sonnet-20240620", "gemini/gemini-1.5-flash"],
            ModelRole.VERIFIER: ["gpt-4o-mini", "gpt-4o", "gemini/gemini-1.5-flash"],
            ModelRole.CRITIC:   ["claude-3-5-sonnet-20240620", "gpt-4o", "xai/grok-beta", "gemini/gemini-1.5-pro"],
        }
